...
public class FileReader {
    ...
    public static Level readProperties(File file) throws IOException {
        ...
        Wall finishLine = new Wall(finishLineStartX, finishLineStartY, finishLineEndX, finishLineEndY,0);
...
while (scanner.hasNextLine()) {
    ...
    if (line.startsWith("wall")) {
        try {
            ...
            int breakable= (int) Double.parseDouble(wallData[5]);
        ...
        level.index = Integer.parseInt(level.name.substring(6));
        return level;
    }
}
